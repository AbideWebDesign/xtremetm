					...
					<?php $bg_img = wp_get_attachment_image_src( get_sub_field('hero_banner_image'), 'hero banner', false ); ?>
						...
						<div class="carousel-item h-100 text-center bg-img <?php echo ( $count == 0 ? 'active' : '' ); ?>" style="background-image: url('<?php echo $bg_img[0]; ?>')">
							...
							<div class="container d-flex h-100">
								...
								<div class="bg-img-content d-flex flex-column align-self-center text-left">
									...
									<h4 class="ml-1 mb-1 mb-lg-0 text-white"><?php the_sub_field('header_banner_sub_title'); ?></h4>
									
									<h1 class="alt text-white mb-0"><?php the_sub_field('hero_banner_title'); ?></h1>
									
									<?php if ( get_sub_field('add_button') ): ?>
									
										<a href="<?php the_sub_field('hero_banner_button_link'); ?>" class="btn btn-primary btn-lg mt-2"><span><?php the_sub_field('hero_banner_button_label'); ?> <i class="fas fa-chevron-right ml-1"></i></span></a>
